...
extension RootTabBarController{
    func addAllChildViewController() -> Void {
        // 主页
        addChildVC(XTHomeViewController(), title: "首页", image: "tabbar_home", selectedImage: "tabbar_home_selected")
        addCenterButton("tabbar_compose_button", title: "+")
        addChildVC(XTOtherViewController(), title: "其他", image: "tabbar_profile_highlighted@2x", selectedImage: "tabbar_profile_selected@2x")
    }
...
extension RootTabBarController{
    func presentModelVC() -> Void {
        ...
        let T = XTCustomTabbarViewController()
